...
Colors.loadColors({
    ...
    primary: ColorsAsset.primary,
    red: ColorsAsset.red,
    red2: ColorsAsset.red2,
    red3: ColorsAsset.red3,
    grey: ColorsAsset.grey,
    grey2: ColorsAsset.grey2,
    grey3: ColorsAsset.grey3,
    grey4: ColorsAsset.grey4,
    green1: ColorsAsset.green1,
    green2: ColorsAsset.green2,
    aliceBlue: ColorsAsset.aliceBlue,
});
